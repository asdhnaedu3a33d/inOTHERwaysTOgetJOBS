function listBelanja_1(clue){
  ...
  function setNominalTahun_1(cond) {
    ...
    if (cond == "tambah") {
      ...
      nominalSatuanTemp = $("#total_belanja").autoNumeric('get');
    ...
    $("#total_belanja").autoNumeric('set', total);
    // document.getElementById("nominal_1").value = total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
  }
  ...
  function ubahrow_1(index, ini) {
    ...
    if (inEdit != "1") {
      ...
      var sumber_dana = $("input[name='kd_sumber_dana_1["+ index +"]']").val();
  ...
  function copyrow_1() {
    var tbl_1 = document.getElementById("listbelanja_1");
    var tbl_2 = document.getElementById("listbelanja_2");
    ...
    for (var idx=1; idx<rowLen; idx++) {
      ...
      td0.appendChild(copy_textnode(inIndex_2));
      ...
      tdHapus.appendChild(generateTeksHapus_2(inIndex_2));

      td12.appendChild(copy_inputnode(inIndex_2, "kd_sumber_dana_2", x.cells[14].getElementsByTagName('input')[0].value));
      td13.appendChild(copy_inputnode(inIndex_2, "r_kd_jenis_belanja_2", x.cells[15].getElementsByTagName('input')[0].value));
      td14.appendChild(copy_inputnode(inIndex_2, "r_kd_kategori_belanja_2", x.cells[16].getElementsByTagName('input')[0].value));
      td15.appendChild(copy_inputnode(inIndex_2, "r_kd_subkategori_belanja_2", x.cells[17].getElementsByTagName('input')[0].value));
      td16.appendChild(copy_inputnode(inIndex_2, "r_kd_belanja_2", x.cells[18].getElementsByTagName('input')[0].value));
      td17.appendChild(copy_inputnode(inIndex_2, "r_uraian_2", x.cells[19].getElementsByTagName('input')[0].value));
      td18.appendChild(copy_inputnode(inIndex_2, "r_det_uraian_2", x.cells[20].getElementsByTagName('input')[0].value));
      td19.appendChild(copy_inputnode(inIndex_2, "r_volume_2", x.cells[21].getElementsByTagName('input')[0].value));
      td20.appendChild(copy_inputnode(inIndex_2, "r_satuan_2", x.cells[22].getElementsByTagName('input')[0].value));
      td21.appendChild(copy_inputnode(inIndex_2, "r_nominal_satuan_2", x.cells[23].getElementsByTagName('input')[0].value));
      td22.appendChild(copy_inputnode(inIndex_2, "r_subtotal_2", x.cells[24].getElementsByTagName('input')[0].value));
  ...
  function copy_textnode(nama) {
    var teks = document.createTextNode(nama);
    return teks;
  }

  function copy_inputnode(index, nama, isi) {
    var idx = document.createElement("input");
    idx.type = "text";
    idx.name = nama+"["+index+"]";
    idx.id = nama+"["+index+"]";
