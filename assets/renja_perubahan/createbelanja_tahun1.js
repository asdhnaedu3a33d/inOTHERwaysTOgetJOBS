function listBelanja_1(clue){
  ...
  if (inEdit != "1") {
    var pr_jenis = "cb_jenis_belanja_2";
    var pr_kategori = "cb_kategori_belanja_2";
    var pr_sub = "cb_subkategori_belanja_2";
    var pr_belanja = "cb_belanja_2";
    var pr_sumber_dana = "sumberdana_2";
  }else {
    var pr_jenis = "cb_jenis_belanja_1";
    var pr_kategori = "cb_kategori_belanja_1";
    var pr_sub = "cb_subkategori_belanja_1";
    var pr_belanja = "cb_belanja_1";
    var pr_sumber_dana = "sumberdana_1";
  }
    ...
    tdnew0.appendChild(generateSumberDana_1(row.rowIndex, pr_sumber_dana))
    td1.appendChild(generateTextBound_1(row.rowIndex, pr_jenis));
    td2.appendChild(generateTextBound_1(row.rowIndex, pr_kategori));
    td3.appendChild(generateTextBound_1(row.rowIndex, pr_sub));
    td4.appendChild(generateTextBound_1(row.rowIndex, pr_belanja));
    ...
    tdnew2.appendChild(generateKodeSumberDana_1(inIndex_1, pr_sumber_dana));
    td11.appendChild(generateTextBox_1(inIndex_1,"r_kd_jenis_belanja_1", pr_jenis));
    td12.appendChild(generateTextBox_1(inIndex_1,"r_kd_kategori_belanja_1", pr_kategori));
    td13.appendChild(generateTextBox_1(inIndex_1,"r_kd_subkategori_belanja_1", pr_sub));
    td14.appendChild(generateTextBox_1(inIndex_1,"r_kd_belanja_1", pr_belanja));
  ...
  function generateSumberDana_1(index, nama) {
    var nilai = $("#"+nama+" option:selected").text();
    var teks = document.createTextNode(nilai);
    return teks;
  }

  function generateKodeSumberDana_1(index, nama) {
    var textField = document.createElement("input");
    textField.type = "text";
    textField.name = "kd_sumber_dana_1["+index+"]";
    textField.id = "kd_sumber_dana_1["+index+"]";
    textField.value = $("#"+nama+"").val();
  ...
  function setNominalTahun_1(cond) {
    var nominalTahunTemp = $("#nominal").autoNumeric('get');
    ...
    document.getElementById("nominal").value = total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".");
  }
