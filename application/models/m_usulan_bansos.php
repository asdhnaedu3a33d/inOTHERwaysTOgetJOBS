...
class M_usulan_bansos extends CI_Model
{
	...
	function get_all_usulan_persetujuan($search, $start, $length, $order, $order_arr, $status = NULL){
	...
	function get_one_usulan_persetujuan($search, $start, $length, $order, $order_arr, $status = NULL){
		...
		$sql = "
			...
			where (
				...
				AND tahun = ".$ta."
				AND SKPD_setuju = '".$id_skpd."' limit 1

		";
		return $this->db->query($sql)->row();
	}

	function get_all_usulan_evaluasi($search, $start, $length, $order, $order_arr, $status = NULL){
		$ta = $this->m_settings->get_tahun_anggaran();
		$user_skpd = $this->session->userdata('username');
		$id_skpd = $this->session->userdata('id_skpd');
	...
	function count_all_usulan_persetujuan($search, $status = NULL){
		$ta = $this->m_settings->get_tahun_anggaran();
		$user_skpd = $this->session->userdata('username');
		$id_skpd = $this->session->userdata('id_skpd');
	...
	function count_all_usulan_evaluasi($search, $status = NULL){
		$ta = $this->m_settings->get_tahun_anggaran();
		$user_skpd = $this->session->userdata('username');
		$id_skpd = $this->session->userdata('id_skpd');
		$sql = "
