...
<script type="text/javascript">
	$(document).ready(function(){    					
		$("#add").click(function(){
			...
			$("#add-box-upload input#ket_file").attr("name", "ket_file["+index+"]");
...
<div class="parent">        			
	<input type="button" id="add" value="Tambah File Upload" />
				...
				<div class="child1-box">
					<table style="border: 1px black;">
	        			...
	        			<tr>
	        				<td>Keterangan</td>
	        				<td>
	        					<input type="text" id="ket_file" name="ket_file[<?php echo $i; ?>]" value="<?php echo $row->ket; ?>"/>	        					
	        				</td>
	        			</tr>
	        			<tr>
	        				<td>File</td>
	        				<td>
	        					<input type="hidden" id="id_file" name = "id_file" value="<?php echo $row->id; ?>" />
	        					<a id="old" href="<?php echo site_url($row->location); ?>"><?php echo $row->file; ?></a>
	        					<input type="button" class="change" value="Ganti File"/>
	        					<input type="hidden" name="id_userfile[<?php echo $i; ?>]" value="<?php echo $row->id; ?>" />
	        					<input type="file" class="userfile" id="userfile" name="userfile[<?php echo $i; ?>]" accept="application/pdf" value="?php echo $row->file; ?>" />	        					
	        				</td>
	        			</tr>
	        			<tr>
	        				<td></td>
			...
			<div class="child1-box">
				<table style="border: 1px black;">
        			...
        			<tr>
        				<td>Keterangan</td>
        				<td>
        					<input type="text" id="ket_file" name="" />	        					
        				</td>
        			</tr>
        			<tr>
        				<td>File</td>
