<script type="text/javascript">
	...
	$(document).ready(function(){
	    dt = $("#rka_table").DataTable({
            ...
            "ajax": {
	            "url": "<?php echo base_url('ppas/load_rka'); ?>",
	            "type": "POST"
	        }
	    });
	...
	function edit_rka(id){
		window.location = '<?php echo base_url('ppas_perubahan/edit_rka/');?>' + '/' + id;
	}

	function delete_rka(id){
		if (confirm('Apakah anda yakin untuk menghapus data ppas ini?')) {
			$.blockUI({
...
<article class="module width_full">
	<header>
	  <h3>Tabel Data PPAS Perubahan</h3>
	</header>
	<div style='float:right'><a href="<?php echo site_url('ppas_perubahan/cru_rka')?>">Tambah Data PPAS</a></div><br>
