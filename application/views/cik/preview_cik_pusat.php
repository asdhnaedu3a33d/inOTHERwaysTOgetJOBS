<article class="module width_full" style="width: 100%;">
    ...
    <fieldset>
    <form action="<?php echo site_url('cik/do_cetak_preview_pusat')?>" id="cik_form" method="POST">
	<table width="99.9%">
        <td width="5%"> Bulan:</td>
        ...
        <td width="75%"> <!--<input type="button" id="cetak" class="btn" value="Cetak"/>--><input type="button" href="<?= base_url('cik/do_export_pusat') ?>" id="export" class="btn" value="Cetak"/></td>
	</table>
    </form>
    </fieldset>
    ...
    $("#search").click(function(){
		...
		var id_bulan = $("#id_bulan").val();
			var data  = {id_bulan:$("#id_bulan").val()};
				$.ajax({
						type: "POST",
						url : "<?php echo site_url('cik/get_data_cik_pusat')?>",
						data: data,
