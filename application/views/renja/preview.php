		...
		<tr>
			...
			<td>
				...
				<table class="table-common" width="100%">
					...
					<tr>
						<td align="center"><?php echo $row_kegiatan->target." ".$row_kegiatan->satuan_target; ?></td>
						<td align="center"><?php echo $row_kegiatan->target_thndpn." ".$row_kegiatan->satuan_target; ?></td>
					</tr>
				</table>
				<hr>
				<?php
