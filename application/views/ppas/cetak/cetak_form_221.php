...
<body>
  ...
  <tbody>
    ...
    $sumurai = $this->db->query("SELECT sum(subtotal) as sumur FROM t_ppas_belanja_kegiatan WHERE tahun = '$ta_ng' AND id_keg = '$idk_ng' AND uraian_belanja = '$rowth1->uraian_belanja' GROUP BY uraian_belanja")->row();
    ...
    $sumurai = $this->db->query("SELECT sum(subtotal) as sumur FROM t_ppas_belanja_kegiatan WHERE tahun = '$ta_ng' AND id_keg = '$idk_ng' AND kode_belanja = '$rowth1->kode_belanja' GROUP BY kode_belanja")->row();
                        echo "
                        <tr>
