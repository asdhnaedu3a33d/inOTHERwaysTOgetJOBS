<script type="text/javascript">
	function veri_ppas(urusan, bidang, skpd){
		window.location = '<?php echo site_url("ppas/veri")?>/' + urusan +'/'+ bidang +'/'+ skpd;
	}
</script>
<article class="module width_full">
	<header>
	  <h3>Verifikasi PPAS Untuk Rancangan Awal (Ranwal)</h3>
	</header>
	<div class="module_content"; style="overflow:auto">
		...
		<?php
				$ppas2 = $this->m_ppas->get_all_bidang_ppas_veri($row->kd);
		...
		<?php
					$ppas3 = $this->m_ppas->get_all_skpd_ppas_veri($row->kd, $row2->kd);
