<script type="text/javascript">
	...
	$("#simpan").click(function(){
	    ...
	    var valid = $("form#kegiatan").valid();
			...
			var tot_belanja = $('#total_belanja').autoNumeric('get');
...
<div style="width: 1200px">
	...
	<div class="module_content">
		<form action="<?php echo site_url('dpa_perubahan/save_kegiatan');?>" method="POST" name="kegiatan" id="kegiatan" accept-charset="UTF-8" enctype="multipart/form-data" >
				...
				<tbody>
					...
					<tr>
				 	...
				 	<tr>
						...
						<td colspan="3"><input type="text" name="total_belanja" id="total_belanja" value="<?php echo $gTotal; ?>" readonly> </td>
			...
			<table>
			<tr>
					<td colspan="2" align="center"><strong>UARAIAN BELANJA</strong></td>
				</tr>
			...
			<div class="submit_link">
				<input type='button' id="tambahjnsbelanja" onclick="errorMessage_1('jns');" style="cursor:pointer;" value="+ Kelompok Belanja">
				<input type='button'  id="tambahkatbelanja" onclick="errorMessage_1('kat');" style="cursor:pointer;" value='+ Jenis Belanja'>
				<input type='button'  id="tambahsubkatbelanja" onclick="errorMessage_1('subkat');" style="cursor:pointer;" value='+ Obyek Belanja'>
				<input type='button'  id="tambahbelanja" onclick="errorMessage_1('belanja');" style="cursor:pointer;" value='+ Rincian Obyek'>
				<input type='button'  id="tambahuraian" onclick="errorMessage_1('uraian');" style="cursor:pointer;" value='+ Rincian Belanja'>
				<input type='button'  id="tambahdeturaian" onclick="errorMessage_1('deturaian');" style="cursor:pointer;" value='+ Sub Rincian Belanja'>
			</div>
			<br>
...
<script src="<?php echo base_url('assets/renstra/createbelanja_tahun_fordpa.js');?>"></script>
<script src="<?php echo base_url('assets/dpa/custom-alert.js');?>"></script>
<link href="<?php echo base_url('assets/dpa/custom-alert.css') ?>" rel="stylesheet" type="text/css" />
...
<script>
  function errorMessage_1(clue) {
    ...
    eliminationName(jenis_belanja, kategori_belanja, subkategori_belanja, kode_belanja, uraian, det_uraian, volume, satuan, nominal, clue, '#cusAlert_1', 'pesan_1');
  }
  ...
  function edit_rcn(id) {
		...
		$.ajax({
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: '<?php echo site_url("dpa_perubahan/get_sum_anggaran_per_bulan"); ?>',
					dataType: "json",
