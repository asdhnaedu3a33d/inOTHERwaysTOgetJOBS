<script type="text/javascript">
	function veri_cik(id,bulan){
		window.location = '<?php echo site_url("cik_perubahan/veri_cik_readonly")?>/' + id +'/' + bulan;
	}
</script>
<article class="module width_full">
    ...
    <form>
	<table width="99.9%">
        <td style="vertical-align: middle !important;" width="5%">Bulan:</td>
		    <td width="25%">
          <select name="id_bulan" id="id_bulan">
    ...
    $("#search").click(function(){
		...
		var id_bulan = $("#id_bulan").val();
			var data  = {id_bulan:$("#id_bulan").val()};
				$.ajax({
						type: "POST",
						url : "<?php echo site_url('cik_perubahan/get_veri_cik_readonly')?>",
						data: data,
