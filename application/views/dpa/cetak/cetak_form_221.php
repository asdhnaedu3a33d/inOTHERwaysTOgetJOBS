...
<body>
  ...
  <tbody>
    ...
    $ta_min = $ta-1;
     ...
     if (empty($nominal['tahun_min']->nominal) ){
      $terbilang_n_min1 = "-";
      $Nominal_n_min =  "-";
      $terbilang_n_min = "-";
      $terbilang_n_min_tulis = "-";
     }else{
      $terbilang_n_min1 = $nominal['tahun_min']->nominal;
      $Nominal_n_min =  Formatting::currency($nominal['tahun_min']->nominal);
      $terbilang_n_min = terbilang($terbilang_n_min1);
      $terbilang_n_min_tulis = "( ". $terbilang_n_min." "."rupiah"." ".")";
     }


     if (empty($nominal['tahun_plus']->nominal) ){
      $terbilang_n_plus1 = "-";
      $Nominal_n_plus = "-" ;
     $terbilang_n_plus = "-";
      $terbilang_n_plus_tulis ="-" ;
     }else{
      $terbilang_n_plus1 = $nominal['tahun_plus']->nominal;
      $Nominal_n_plus =  Formatting::currency($nominal['tahun_plus']->nominal) ;
     $terbilang_n_plus = terbilang( $terbilang_n_plus1);
     $terbilang_n_plus_tulis = "( ". $terbilang_n_plus." "."rupiah"." ".")";
     }


     if (empty($nominal['tahun_n']->nominal) ){
      $terbilang_n1 = "-";
      $Nominal_n =  "-";
      $terbilang_n = "-";
      $terbilang_n_tulis = "-";
     }else{
      $terbilang_n1 = $nominal['tahun_n']->nominal;
      $Nominal_n =  Formatting::currency($nominal['tahun_n']->nominal);
    ...
    <tr>
      ...
      <td id="header3" style="border-left:none ; border-right:none"><strong>: </strong>Rp<strong><br>
        : </strong>Rp<strong><br>
      :</strong> Rp</td>
      <td id="header3" style="border-left:none ; border-right:none; "> <?php echo $Nominal_n_min; ?> &nbsp; <em><?php echo $terbilang_n_min_tulis; ?></em>
    ...
    <tr>
      ...
      <?php
            ...
            echo "Rp."." ". Formatting::currency($nominal['tahun_n']->nominal)  ;
    ...
    $sumurai = $this->db->query("SELECT sum(subtotal) as sumur FROM tx_dpa_belanja_kegiatan WHERE tahun = '$ta_ng' AND id_keg = '$idk_ng' AND uraian_belanja = '$rowth1->uraian_belanja' GROUP BY uraian_belanja")->row();
    ...
    $sumurai = $this->db->query("SELECT sum(subtotal) as sumur FROM tx_dpa_belanja_kegiatan WHERE tahun = '$ta_ng' AND id_keg = '$idk_ng' AND kode_belanja = '$rowth1->kode_belanja' GROUP BY kode_belanja")->row();
                        echo "
                        <tr>
