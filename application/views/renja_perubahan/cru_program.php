<script type="text/javascript">
	...
	$("#tambah_indikator_program").click(function(){
		...
		$("#indikator_box_program input#target").attr("value", '0');
...
<div style="width: 900px">
	...
	?>
    <br />
		<form action="<?php echo site_url('renja_perubahan/save_program_renja');?>" method="POST" name="program" id="program" accept-charset="UTF-8" enctype="multipart/form-data" >
