			...
			<table class="fcari" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>Rp. <input type="text" id ="nominal" name="nominal" value="<?php if(!empty($kegiatan->nominal)){echo $kegiatan->nominal;} ?>" readonly/>
                        </td>
						<td bgcolor="#CCCCCC">Rp. <input type="text" id="nominal_thndpn" name="nominal_thndpn" value="<?php if(!empty($kegiatan->nominal_thndpn)){echo $kegiatan->nominal_thndpn;} ?>" readonly/>
                        </td>
					</tr>
					<tr>
						<td>&nbsp;&nbsp;Lokasi</td>
