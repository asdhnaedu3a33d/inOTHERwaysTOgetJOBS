<script type="text/javascript">
	...
	function listBelanja(){
			...
			$('#kode_jenis_belanja_autocomplete').val('');
		...
		function generateJenisBelanja(index) {
			...
			jnsbelanja.name = "kodejenisbelanja_detil[]";
		...
		function generateKategoriBelanja(index) {
			...
			katbelanja.name = "kodekategoribelanja_detil[]";
		...
		function generateSubKategoriBelanja(index) {
			...
			subkatbelanja.name = "subkategoribelanja_detil[]";
		...
		function generateBelanja(index) {
			...
			belanja.type = "hidden";
			belanja.name = "kodebelanja_detil[]";
...
<article class="module width_full">
 	...
 	<div class="module_content">
		...
		<div class="submit_link">
			<input type='button' id="tambah" onclick="listBelanja();" style="cursor:pointer;" value="Tambah">
		</div>		
