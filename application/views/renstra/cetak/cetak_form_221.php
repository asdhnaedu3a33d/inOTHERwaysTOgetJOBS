...
function terbilang($x){
    ...
    $ta_min = $ta-1;
     ...
     if ($ta_min =='1'){
      $terbilang_n_min1 = $tahun1[0]->nominal_1;
          $Nominal_n_min =  Formatting::currency($tahun1[0]->nominal_1); 
           $terbilang_n_min = terbilang($terbilang_n_min1);
            ...
            $terbilang_n_min1 = $tahun1[0]->nominal_2;
             $Nominal_n_min =  Formatting::currency($tahun1[0]->nominal_2); 
             $terbilang_n_min = terbilang($terbilang_n_min1); 
              $terbilang_n_min_tulis = "( ". $terbilang_n_min." "."rupiah"." ".")";
          }elseif ($ta_min =='3') {
             $terbilang_n_min1 = $tahun1[0]->nominal_3;
             $Nominal_n_min =  Formatting::currency($tahun1[0]->nominal_3); 
             $terbilang_n_min = terbilang($terbilang_n_min1);
              $terbilang_n_min_tulis = "( ". $terbilang_n_min." "."rupiah"." ".")";
          }elseif ($ta_min =='4') {
             $terbilang_n_min1 = $tahun1[0]->nominal_4;
             $Nominal_n_min =  Formatting::currency($tahun1[0]->nominal_4); 
             $terbilang_n_min = terbilang($terbilang_n_min1);
              $terbilang_n_min_tulis = "( ". $terbilang_n_min." "."rupiah"." ".")";
          }elseif ($ta_min =='5') {
             $terbilang_n_min1 = $tahun1[0]->nominal_5;
           $Nominal_n_min =  Formatting::currency($tahun1[0]->nominal_5);  
           $terbilang_n_min = terbilang($terbilang_n_min1);
            $terbilang_n_min_tulis = "( ". $terbilang_n_min." "."rupiah"." ".")";
          }else{
          $terbilang_n_min1 = "-";
      ...
      if ($ta_plus =='1'){
            $Nominal_n_plus =  Formatting::currency($tahun1[0]->nominal_1);
           ...
           $terbilang_n_plus = terbilang( $terbilang_n_plus1); 
            $terbilang_n_plus_tulis = "( ". $terbilang_n_plus." "."rupiah"." ".")";
             ...
             $Nominal_n_plus =  Formatting::currency($tahun1[0]->nominal_2);
              $terbilang_n_plus1 = $tahun1[0]->nominal_2;
           $terbilang_n_plus = terbilang( $terbilang_n_plus1); 
            $terbilang_n_plus_tulis = "( ". $terbilang_n_plus." "."rupiah"." ".")";
          }elseif ($ta_plus =='3') {
            $Nominal_n_plus =  Formatting::currency($tahun1[0]->nominal_3);
             $terbilang_n_plus1 = $tahun1[0]->nominal_3;
           $terbilang_n_plus = terbilang( $terbilang_n_plus1); 
            $terbilang_n_plus_tulis = "( ". $terbilang_n_plus." "."rupiah"." ".")";
          }elseif ($ta_plus =='4') {
            $Nominal_n_plus =  Formatting::currency($tahun1[0]->nominal_4);
             $terbilang_n_plus1 = $tahun1[0]->nominal_4;
           $terbilang_n_plus = terbilang( $terbilang_n_plus1); 
            $terbilang_n_plus_tulis = "( ". $terbilang_n_plus." "."rupiah"." ".")";
          }elseif ($ta_plus =='5') {
          $Nominal_n_plus =  Formatting::currency($tahun1[0]->nominal_5);
        ...
        if ($ta =='1'){
            $Nominal_n =  Formatting::currency($tahun1[0]->nominal_1);
            ...
            $Nominal_n =  Formatting::currency($tahun1[0]->nominal_2);
             $terbilang_n1 = $tahun1[0]->nominal_2; 
            $terbilang_n = terbilang($tahun1[0]->nominal_2);
             $terbilang_n = terbilang($terbilang_n1); 
            $terbilang_n_tulis = "( ". $terbilang_n." "."rupiah"." ".")";
          }elseif ($ta =='3') {
             $Nominal_n =  Formatting::currency($tahun1[0]->nominal_3);
            $terbilang_n1 = $tahun1[0]->nominal_3; 
            $terbilang_n = terbilang($tahun1[0]->nominal_3);
             $terbilang_n = terbilang($terbilang_n1); 
            $terbilang_n_tulis = "( ". $terbilang_n." "."rupiah"." ".")";
          }elseif ($ta =='4') {
             $Nominal_n =  Formatting::currency($tahun1[0]->nominal_4);
             $terbilang_n1 = $tahun1[0]->nominal_4;
            $terbilang_n = terbilang($tahun1[0]->nominal_1);
             $terbilang_n = terbilang($terbilang_n1); 
            $terbilang_n_tulis = "( ". $terbilang_n." "."rupiah"." ".")"; 
          }elseif ($ta =='5') {
           $Nominal_n =  Formatting::currency($tahun1[0]->nominal_5);
    ...
    <tr>
      ...
      $sumurai = $this->db->query("SELECT sum(subtotal) as sumur FROM t_renstra_belanja_kegiatan WHERE tahun = '$ta_ng' AND id_kegiatan = '$idk_ng' AND uraian_belanja = '$rowth1->uraian_belanja' GROUP BY uraian_belanja")->row();
