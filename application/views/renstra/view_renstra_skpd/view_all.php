<script type="text/javascript">
	function veri_renstra(id){
		window.location = '<?php echo site_url("renstra/view_detil_renstra_skpd")?>/' + id;
	}
</script>
	...
	<div class="module_content"; style="overflow:auto">
		<table id="renstra" class="table-common" style="width:99%">
			<thead>
				<tr>
					...
					<th>SKPD</th>
					<th>Jumlah Data</th>
					<th style="display:none;">Jumlah Dapat Diproses</th>
					<th>Action</th>
				</tr>				
			</thead>
			<tbody>
		...
		?>
				<tr>
					...
					<td style="display:none;" align="center"><?php echo $row->jum_dikirim; ?></td>
