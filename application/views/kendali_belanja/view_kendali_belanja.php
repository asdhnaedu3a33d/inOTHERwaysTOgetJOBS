...
$(document).ready(function(){
    ...
    var is_prog_or_keg = element.attr("is_prog_or_keg");
		...
		$.ajax({
			type: "POST",
			url: '<?php echo site_url("kendali/get_kendali_langsung_bulanan"); ?>',
...
<article class="module width_full" style="width: 130%; margin-left: -15%;">
	...
	<div class="text-right form-group">
		<a href="<?php echo site_url('kendali/kirim_veri') ?>"><input style="margin: 3px 10px 0px 0px;" type="button" value="Kirim Kendali Belanja" /></a>
		<a href="javascript:void(0)" id="cetak_aksi"><input style="margin: 3px 10px 0px 0px;" type="button" value="Cetak Realisasi Aksi" /></a>
    <a href="<?php echo site_url('kendali/do_cetak_kendali_belanja') ?>"><input style="margin: 3px 10px 0px 0px;" type="button" value="Cetak Kendali Belanja" /></a>
    <a href="<?php echo site_url('kendali/preview_kendali_belanja') ?>"><input style="margin: 3px 10px 0px 0px;" type="button" value="Lihat Kendali Belanja" /></a>
	</div>
  <div class="scroll">
  	<table id="kendali_skpd" class="table-common tablesorter" style="max-width:100% !important; width:100% !important" >
  		<thead>
  				<tr>
