...
<div style="width: 900px">
    ...
    <form action="<?php echo site_url('kendali/save_kendali_renja');?>" method="POST" name="program" id="program"
    ...
    <table class="fcari" width="99.8%">
        <tbody>
            ...
            <tr>
                ...
                <td>
                <textarea class="common" name="hasil_kendali" rows="4"><?php echo (!empty($kendali->hasil_kendali))? $kendali->hasil_kendali:''; ?></textarea>
                </td>
            </tr>
            <tr>
                <td>Tindak Lanjut</td>
                <td>
                <textarea class="common" name="tindak_lanjut" rows="4"><?php echo (!empty($kendali->tindak_lanjut))? $kendali->tindak_lanjut:''; ?></textarea>
                </td>
            </tr>
            <tr>
                <td>Hasil Tindak Lanjut</td>
                <td>
                <textarea class="common" name="hasil_tl" rows="4"><?php echo (!empty($kendali->hasil_tl))? $kendali->hasil_tl:''; ?></textarea>
                </td>
            </tr>
        </tbody>
    </table>
