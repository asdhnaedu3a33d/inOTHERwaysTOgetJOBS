...
<div style="width: 900px">
	...
	<?php
		if (!empty($program)){
		    echo "Edit Data Program RKA Perubahan";
		} else{
		    echo "Input Data Program RKA Perubahan";
		}
	?>
	</h3>
	</header>
	<div class="module_content">
		<form action="<?php echo site_url('rka_perubahan/save_program_rka');?>" method="POST" name="program" id="program" accept-charset="UTF-8" enctype="multipart/form-data" >
							...
							?>
								...
								<div style="width: 100%;">
									<table class="table-common" width="100%">
										...
										<tr style="width:100%">
											<td>Target</td>
                                            <td><input style="width: 100%;" type="text" class="target" name="target[<?php echo $i; ?>]" value="<?php echo (!empty($row->target))?$row->target:'0.00'; ?>" readonly></td>
                                            <td>Target</td>
		...
		<div style="width: 100%;">
			<table class="table-common" width="100%">
				...
				<tr style="width:100%">
                    ...
                    <td>Target</td>
					<td><input style="width: 100%;" type="text" class="target" id="target_thndpn" name="target_thndpn[1]" value="0" readonly></td>
				</tr>
			</table>
		</div>
	</div>
