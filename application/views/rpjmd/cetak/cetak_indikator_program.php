	...
	<tbody>
		...
		<?php $no=1; foreach ($dataprogram as $rowprogram ) { 
			$dataindikator =  $this->m_rpjmd_trx->get_indikator_program_cetak($rowprogram->id);
			//print_r($dataindikator);exit();
		...
		<?php if ($count==0) { ?>
			...
			<td align="left" style="border-left: 0;"rowspan="<?php echo $totalindikator; ?>"><?php echo $rowprogram->nama_prog;?> </td>.
		<?php } ?>
		...
		<td ><?php echo $rowindikator->kondisi_akhir.' '.$rowindikator->satuan_target;?> </td>
	</tr>
