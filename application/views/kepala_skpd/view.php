...
<script type="text/javascript">
	$(document).ready(function(){
		$(".veri_keg").click(function(){
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('renstra/do_veri_kepala_skpd'); ?>",
		...
		$(".veri_prog").click(function(){
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('renstra/do_veri_prog_kepala_skpd'); ?>",
		...
		$("#approve_renstra").click(function(){
			prepare_facebox();
			$.blockUI({
				css: window._css,
				overlayCSS: window._ovcss
	    	...
	    	$.ajax({
				type: "POST",
				url: "<?php echo site_url('renstra/approve_renstra_kepala_skpd'); ?>",
...
<article class="module width_full" style="width: 138%; margin-left: -19%;">
	<header>
	  <h3>Verifikasi Renstra Untuk Kepala SKPD</h3>
	</header>
	<div class="module_content";>
		...
		<div style="overflow:auto">
			<table class="table-common" width="100%">
				...
				<?php
					}elseif ($row->is_verifikasi == 2) {
				?>
							<i style="color:red;">Tidak Disetujui</i>
				<?php
					}elseif ($row->is_verifikasi == 1) {
				?>
	...
	<footer>
		<div class="submit_link">
			<input id-r="<?php echo $skpd_visi->id; ?>" type="button" id="approve_renstra" value="Setujui Renstra">
		</div>
	</footer>
</article>
