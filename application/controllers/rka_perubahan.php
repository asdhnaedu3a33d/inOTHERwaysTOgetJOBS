...
// print_r($this->db->last_query());
	...
	function save_kegiatan(){
		...
		if (!empty($id)) {
			$result = $this->m_rka_perubahan->edit_kegiatan_skpd($data, $id, $indikator, $id_indikator_kegiatan, $satuan_target,$status_indikator, $kategori_indikator, $target, $target_thndpn, $dataKegiatan1, $dataKegiatan2);
		}else{
			$result = $this->m_rka_perubahan->add_kegiatan_skpd($data, $indikator, $satuan_target,$status_indikator, $kategori_indikator, $target, $target_thndpn, $dataKegiatan1, $dataKegiatan2);
		}
